...
export default function InvoiceDetail({ invoice = sampleInvoice }) {
  ...
  const timeline = {
    ...
    completed_at: invoice?.completed_date,
  };
  ...
  return (
    <div className="min-h-screen print:bg-white print:p-0 p-6">
      ...
      <div className="max-w-4xl mx-auto flex gap-5 bg-white shadow-xl print:shadow-none rounded-2xl print:rounded-none  print:border-none">
        <div>
