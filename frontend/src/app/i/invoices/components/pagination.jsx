        ...
        <ul className="inline-flex items-stretch -space-x-px">
          ...
          <li>
            <a
              href="#"
              aria-current="page"
              className="flex items-center justify-center text-sm z-10 py-2 px-3 leading-tight text-teal-600 bg-teal-50 border border-teal-300 hover:bg-teal-100 hover:text-teal-700 dark:border-gray-700 dark:bg-teal-600 "
            >
              3
            </a>
          </li>
