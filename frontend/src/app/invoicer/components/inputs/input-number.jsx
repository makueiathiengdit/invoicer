    ...
    <>
      <div className="min-h-8 w-full">
        ...
        <input
          ...
          value={value}
          onChange={onChange}
          className="w-full rounded-md border border-[#e0e0e0] bg-white py-1 px-2 text-sm md:py-2 md:px-4 md:text-base md:font-medium text-[#6B7280] outline-none  focus:border-[#5791ee] focus:shadow-md"
